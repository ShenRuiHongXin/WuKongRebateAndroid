...
public class TopLayoutManager extends GridLayoutManager {
    ...
    public TopLayoutManager(Context context, int spanCount) {
        super(context, spanCount);
    }

    public TopLayoutManager(Context context, int spanCount, int orientation, boolean reverseLayout) {
