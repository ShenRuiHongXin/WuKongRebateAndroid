...
public class SearchResultActivity extends Activity {
    ...
    @ViewById(R.id.tv_index_goods_current)
    TextView tvCurrentNumber;
    @ViewById(R.id.tv_index_goods_total)
    ...
    void downloadGoodsList(int action,int pageNo){
        if (Utils.isNetworkConnected(this)){
            Map<String, Object> result = GetNetWorkDatas.getSearchGoods(goods, pageNo);
    ...
    private void initView() {
        ...
        adapter = new SearchGoodsAdater(this,goodsList);
    ...
    @Click({R.id.iv_search_result_back,R.id.tv_search_result,R.id.layout_index_circle})
