...
public class FileDownloadManager {
     ...
     * @return download id
     */
    public long startDownload(String uri, String title, String description,String appName,String versionName) {
...
//        req.setDestinationInExternalFilesDir(context, Environment.DIRECTORY_DOWNLOADS, appName+".apk");
        ...
        req.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, appName+"_"+versionName+".apk");
        //第三种 自定义文件路径
