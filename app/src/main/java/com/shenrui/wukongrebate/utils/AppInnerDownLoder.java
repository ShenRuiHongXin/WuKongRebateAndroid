...
public class AppInnerDownLoder {
	public final static String SD_FOLDER = Environment.getExternalStorageDirectory()+ "/wkDownload/";
	...
	public static void downLoadApk(final Context mContext,final String downURL,final String appName,final String versionName) {
		...
		new Thread() {
			...
			public void run() {
				try {
					File file = downloadFile(downURL,appName,versionName,pd);
					sleep(3000);
	 ...
	 * @throws Exception
	 */
	private static File downloadFile(String path,String appName,String versionName ,ProgressDialog pd) throws Exception {
		...
		if (Environment.MEDIA_MOUNTED.equals(Environment
			...
			String fileName = SD_FOLDER + appName+"_"+versionName+".apk";
